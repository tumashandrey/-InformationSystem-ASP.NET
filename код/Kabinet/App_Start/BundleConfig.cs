...
namespace Kabinet
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/jquery-tablesorter-pager").Include(
                "~/Scripts/tablesorter/widget-pager.js"));

            bundles.Add(new ScriptBundle("~/bundles/jquery-tablesorter-widgets").Include(
